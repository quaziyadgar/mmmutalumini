...
function(a, b) {
    ...
    g.prototype.init = function() {
        ...
        var a = this,
            d = a.options;
        this.isOpen && (this.isOpen = !1, this._addClasses(this.$element, this.isOpen, !0), this._addClasses(this.$content, this.isOpen, !0), this.options.modal && this._addClasses(this.$modal, this.isOpen, !0), this.$element.attr("aria-hidden", "true").addClass(e.createModifierClass(d.baseClass, "closing")).trigger("closing." + c), this.trapTabKey.unbindTrap(), a.$trigger && a.$trigger.button._isExpanded(!1), e.onEndTransition(this.transitionElement, function() {
            a._addClasses(a.$element, a.isOpen, !1), a._addClasses(a.$content, a.isOpen, !1), a.options.modal && a._addClasses(a.$modal, a.isOpen, !1), a.$content.removeClass(a._contentOpenClasses.join(" ")), a.$element.removeClass(e.createModifierClass(d.baseClass, "closing")), b("html, body").removeClass(a._bodyOpenClasses.join(" ")), a.lastFocus && a.lastFocus.focus()
        ...
        function f() {
            d(), h.$element.trigger("resizing." + c), h.options.resize && h.close()
        }
        var g, h = this;
        ...
        c = b(e.triggerButton ? e.triggerButton : "[" + g + "='" + f + "']"), new a.componentNamespace.OffcanvasTrigger(c[0], {
            offcanvas: f
        }).init()
